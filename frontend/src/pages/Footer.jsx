...
import VyraDesignsLogo from "../assets/vyradesigns-white-transparent.png";
...
const Footer = () => {
  return (
    <div className="w-full flex flex-col gap-[0.5px] ">
      <div className="flex flex-col md:flex-row items-center md:items-start justify-between gap-5 md:gap-0 px-5 md:px-10 py-10 bg-black">
        ...
        <div className="flex flex-col gap-5 px-10 items-center md:items-start">
          ...
          <div className="flex flex-col gap-2 items-center md:items-start">
            <div className="text-slate-300 cursor-pointer hover:text-white">
              About
            </div>
            <div className="text-slate-300 cursor-pointer hover:text-white">
              Cart
          ...
          <div className="flex flex-col items-center md:items-start">
            <div className="text-white text-2xl font-bold">Site Links</div>
            <div className="flex flex-col gap-2 items-center md:items-start">
              <div className="text-slate-300 cursor-pointer hover:text-white">
                Privacy Policy
              </div>
      ...
      <div className="w-full flex flex-col md:flex-row justify-center md:justify-between items-center bg-black h-24">
        <div className="flex flex-row  items-center gap-1 h-full px-5">
          <div className="text-slate-300">Copyright © 2024</div>
          <div className="text-slate-300">|</div>
          <div className="text-slate-300">Vyra Designs</div>
        </div>
